...
# LinearRegression(lamda = 10, sigma = 0.00001)
# LinearRegression(lamda = 10, sigma = 0.0001)
# LinearRegression(lamda = 10, sigma = 0.001)
# LinearRegression(lamda = 10, sigma = 0.01)
# LinearRegression(lamda = 10, sigma = 0.1)
# LinearRegression(lamda = 10, sigma = 1.0)
# LinearRegression(lamda = 10, sigma = 10.0)
# LinearRegression(lamda = 10, sigma = 100.0)
# LinearRegression(lamda = 10, sigma = 1000.0)
#LinearRegression(lamda = 10, sigma = 1000000000.0)
...
#LinearRegression(lamda = 10000000000, sigma = 0.1)
